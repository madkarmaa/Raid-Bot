...
2. Download and run [**install.bat**](https://raw.githubusercontent.com/madkarmaa/Raid-Bot/main/install.bat). It will automatically download the bot and install the libraries.
