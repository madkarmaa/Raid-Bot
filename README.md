...
2. Download and run [**install.bat**](https://dl.dropboxusercontent.com/s/27fwhfi847khcas/install.bat?dl=1). It will automatically download the bot and install the libraries.
